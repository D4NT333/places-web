          ...
          <div style={styles.headerContent}>
            ...
            <div style={styles.headerText}>
              ...
              <p style={styles.subtitle}>
                ...
                qué la descripción propuesta será
                rechazada.
              </p>
            </div>
          </div>
          ...
          <section style={styles.formSection}>
            <div style={styles.sectionHeading}>
              ...
              <div>
                ...
                <p style={styles.fieldHelper}>
                  Explica claramente qué problema
                  tiene la descripción propuesta.
                </p>
              </div>
            </div>
            ...
            <div style={styles.textareaWrapper}>
              <textarea
                ...
                placeholder="Ejemplo: La descripción contiene información incorrecta o no representa adecuadamente el lugar."
                value={comment}
                onChange={(event) =>
                  setComment(
                    event.target.value
        ...
        {showCancelConfirm && (
          ...
          >
            ...
            >
              ...
              >
                Se perderá el motivo seleccionado y
